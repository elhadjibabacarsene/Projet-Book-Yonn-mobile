  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBarInscription(stepperVisibily: false, numberStep: inscriptionFormSteps.getNumberStep()),
      ),
       ...
       Container(   
         ...
         SizedBox(height: 35,),
              ...
              Container(
                  ...
                  child: Text('J\'ai oublié mon mot de passe', style: TextStyle(color: Colors.blueAccent.shade700,fontSize: 16, fontWeight: FontWeight.bold),),
                ),
                SizedBox(height: 95,),
               Container(
            ...
            text: new TextSpan(
              children: [
                ...
                new TextSpan(
                  text: 'S\'inscire',
                  style: new TextStyle(fontWeight: FontWeight.bold,color: Colors.blueAccent.shade700,fontSize: 18,),
